**DHCN model integrated with Atten-Mixer (Atten-Mixer Enhanced Graph Neural Network for Session-based Recommendation).**
...
* Up to 99% reduction in training time compared to original DHCN
